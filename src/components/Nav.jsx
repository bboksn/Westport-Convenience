...
export default function Nav() {
  ...
  return (
    ...
    <div className='flex bg-[#191b1e] h-24 text-white flex-row items-center w-full mx-auto px-6 justify-between '>
      <a className='font-bold text-5xl text-green-600 font-[cool] lg:text-6xl' href='/'>WESTPORT CONVENIENCE</a>
    ...
    <div className={nav?'text-black h-72 bg-[#e0dedb10] lg:hidden flex flex-col font-semibold transition duration-500 ease-in-out':'hidden duration-500 ease-in-out'}>
